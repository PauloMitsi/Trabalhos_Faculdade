...
public class EditCliente extends javax.swing.JFrame {
    ...
    protected Conta con;
    protected int auxAgencia;
    private static EditCliente EDI;
    ...
    public static EditCliente getCadCliente() {
        if (EDI == null) {
            EDI = new EditCliente();
        }
        return EDI;
    ...
    public EditCliente(Conta c) {
        initComponents();
        cxNome.setText(c.getTitular().getNome());
        cxIdade.setText(String.valueOf(c.getTitular().getIdade()));
        cxCPF.setText(c.getTitular().getCpf());
        cxAgencia.setText(String.valueOf(c.getAgencia()));
        cxAgencia.setText(String.valueOf(c.getAgencia()));
        cxNumero.setText(String.valueOf(c.getNumero()));
        auxAgencia = c.getAgencia();
    ...
    public void editCliente() {
        ...
        int tipoC = cbContas.getSelectedIndex();
        ...
        if (confirma) {
            ...
            con = setConta(tipoC, Integer.parseInt(agencia), Integer.parseInt(numero));
            con.setTitular(cli);

            String sql = String.format("update conta set agencia = '%d', numero = '%d', conta_tipo ='%s' where cpf = '%s' and agencia = '%d' ",
    ...
    public void CancEdi() {
        int saiu = JOptionPane.showConfirmDialog(null,
    ...
    public Conta setConta(int t, int age, int num) {
        switch (t) {
            case 0: {
                return new ContaCorrente(age, num);
            }
            case 1: {
                return new ContaPoupanca(age, num);
            }
            default: {
                return new SeguroDeVida(age, num);
            }
